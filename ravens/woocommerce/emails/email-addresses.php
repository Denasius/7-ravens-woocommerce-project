	...
	<tr>
		<td style="text-align:<?php echo $text_align; ?>; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif; border:0; padding:0;" valign="top" width="50%">
			...
			<address class="address">
				<div class="name">
					<p class="name_1">Имя:</p>
				<p class="name_2"><?php echo ( $address = $order->get_formatted_billing_address() ) ? $address : __( 'N/A', 'woocommerce' ); ?></p>
				</div>
				<div class="phone">
					...
					<?php if ( $order->get_billing_email() ) : ?>
						<p class="email_1">E-mail:</p>
						<p class="email_2"><?php echo esc_html( $order->get_billing_email() ); ?></p>
					<?php endif; ?>
				</div>
			</address>
		</td>
